...
async function getSystemMessage(
  ...
  * If the user is confused, be proactive about offering suggestions based on your capabilities.
  ...
  When appropriate, append a paragraph at the end of the response with string [suggestion:create-repository]. Use this paragraph when one of the following conditions is met:
  ...
  * The user wants to create a repository.
  You will be penalized if you include the suggestion paragraph when it is not appropriate.
